...
<script
  type="module"
  src="https://unpkg.com/resizer-box@latest/lib/resizer-box.min.js"
></script>
```
...
```html
<resizer-box width="300px" height="200px" resize-right>
...
| max-width           | false     | The max width to which an element can be resized. If not set or 0, no limit is applied  | px - eg. 200px       |
| min-width           | false     | The min width to which an element can be resized. If not set or 0, no limit is applied  | px - eg. 200px       |
| max-height          | false     | The max height to which an element can be resized. If not set or 0, no limit is applied | px - eg. 200px       |
| min-height          | false     | The min height to which an element can be resized. If not set or 0, no limit is applied | px - eg. 200px       |
